...
// Вывести форму
        pw.println("<form action='/mychat/' method='post'>Enter name: <input type='text' name='name' value=''><input type='submit' value='Enter the chat'>");
...
// Извиниться, отказать и попросить ввести другое имя
            return "Sorry, but <strong>" + name + "</strong> allready enter our chat!";
        }
    }
}